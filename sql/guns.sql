...
-- Records of dept
-- ----------------------------
INSERT INTO `dept` VALUES ('24', '1', '0', '[0],', '银圆科技集团', '银圆科技集团', '', null);
...
INSERT INTO `dept` VALUES ('34', '5', '24', '[0],[24],', '财务部', '财务部', '', null);
...
CREATE TABLE `login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 COMMENT='登录记录';
...
INSERT INTO `login_log` VALUES ('130', '登录日志', '1', '2017-08-04 14:48:53', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('131', '退出日志', '1', '2017-08-04 14:53:05', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('132', '登录日志', '1', '2017-08-04 14:53:22', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('133', '登录日志', '1', '2017-08-04 14:59:26', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('134', '登录日志', '45', '2017-08-04 15:21:05', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('135', '退出日志', '1', '2017-08-04 15:56:55', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('136', '登录日志', '1', '2017-08-04 15:58:13', '成功', null, '127.0.0.1');
INSERT INTO `login_log` VALUES ('137', '登录日志', '1', '2017-08-04 16:38:13', '成功', null, '127.0.0.1');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES ('6', '世界', '10', '欢迎使用银圆科技后台管理系统', '2017-01-11 08:53:20', '1');
...
INSERT INTO `operation_log` VALUES ('483', '业务日志', '修改管理员', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'edit', '2017-08-04 14:52:30', '成功', '账号=admin;;;字段名称:头像,旧值:girl.gif,新值:36c47e3b-9c34-4c19-b1f0-d2f22de7097c.jpg');
INSERT INTO `operation_log` VALUES ('484', '业务日志', '修改管理员', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'edit', '2017-08-04 14:52:57', '成功', '账号=admin;;;字段名称:头像,旧值:girl.gif,新值:36c47e3b-9c34-4c19-b1f0-d2f22de7097c.jpg;;;字段名称:名字,旧值:张三,新值:姜坤银;;;字段名称:电子邮件,旧值:sn93@qq.com,新值:jky1988@qq.com');
INSERT INTO `operation_log` VALUES ('485', '业务日志', '修改管理员', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'edit', '2017-08-04 15:04:14', '成功', '账号=admin;;;字段名称:性别,旧值:女,新值:男');
INSERT INTO `operation_log` VALUES ('486', '业务日志', '分配角色', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'setRole', '2017-08-04 15:04:37', '成功', '账号=test,角色名称集合=临时');
INSERT INTO `operation_log` VALUES ('487', '业务日志', '添加管理员', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'add', '2017-08-04 15:18:37', '成功', '账号=wln_tell_me');
INSERT INTO `operation_log` VALUES ('488', '业务日志', '分配角色', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'setRole', '2017-08-04 15:18:51', '成功', '账号=wln_tell_me,角色名称集合=超级管理员,临时');
INSERT INTO `operation_log` VALUES ('489', '业务日志', '分配角色', '1', 'com.stylefeng.guns.modular.system.controller.UserMgrController', 'setRole', '2017-08-04 15:19:09', '成功', '账号=wln_tell_me,角色名称集合=临时');
INSERT INTO `operation_log` VALUES ('490', '业务日志', '配置权限', '1', 'com.stylefeng.guns.modular.system.controller.RoleController', 'setAuthority', '2017-08-04 15:19:49', '成功', '角色名称=临时,资源名称=系统管理,登录日志,清空登录日志,登录日志列表,通知管理,添加通知,修改通知,删除通知,通知,接口文档');
INSERT INTO `operation_log` VALUES ('491', '业务日志', '修改通知', '1', 'com.stylefeng.guns.modular.system.controller.NoticeController', 'update', '2017-08-04 15:26:38', '成功', '标题=世界;;;字段名称:内容,旧值:欢迎使用Guns管理系统,新值:欢迎使用银圆科技后台管理系统');
INSERT INTO `operation_log` VALUES ('492', '业务日志', '修改部门', '1', 'com.stylefeng.guns.modular.system.controller.DeptController', 'update', '2017-08-04 16:06:39', '成功', '部门简称=银圆科技集团;;;字段名称:部门简称,旧值:总公司,新值:银圆科技集团;;;字段名称:部门全称,旧值:总公司,新值:银圆科技集团');
INSERT INTO `operation_log` VALUES ('493', '业务日志', '添加部门', '1', 'com.stylefeng.guns.modular.system.controller.DeptController', 'add', '2017-08-04 16:07:53', '成功', '部门简称=财务部');
...
CREATE TABLE `relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3689 DEFAULT CHARSET=utf8 COMMENT='角色和菜单关联表';
...
INSERT INTO `relation` VALUES ('3679', '105', '5');
INSERT INTO `relation` VALUES ('3680', '133', '5');
INSERT INTO `relation` VALUES ('3681', '160', '5');
INSERT INTO `relation` VALUES ('3682', '161', '5');
INSERT INTO `relation` VALUES ('3683', '141', '5');
INSERT INTO `relation` VALUES ('3684', '142', '5');
INSERT INTO `relation` VALUES ('3685', '143', '5');
INSERT INTO `relation` VALUES ('3686', '144', '5');
INSERT INTO `relation` VALUES ('3687', '145', '5');
INSERT INTO `relation` VALUES ('3688', '149', '5');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '36c47e3b-9c34-4c19-b1f0-d2f22de7097c.jpg', 'admin', '6ce14f8d954ca3c7b3f981df218d6572', '8pgby', '姜坤银', '2017-05-05 00:00:00', '1', 'jky1988@qq.com', '18200000000', '1', '27', '1', '2016-01-29 08:49:53', '25');
...
INSERT INTO `user` VALUES ('45', null, 'wln_tell_me', '45b87c67b9c51d0d1a287c9b187007f1', 's9xs6', '王利娜', '1994-08-04 00:00:00', '2', '1017104673@qq.com', '17785135653', '5', '25', '1', '2017-08-04 15:18:37', null);
